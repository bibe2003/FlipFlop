...
public class ChallengeOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CH_TABLE_NAME = "Challenge";
    public static final String KEY_SCORE = "score";
    SQLiteDatabase db = this.getWritableDatabase(); //get actual instance of DB
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		    ...
		    db.execSQL("DROP TABLE IF EXISTS " + CH_TABLE_NAME);
		    onCreate(db);
	...
	public void addScore (int newScore)
	{
		...
		db.insert(CH_TABLE_NAME, null, vals); //insert into table
	...
	public List<String> getAllScores ()
	{
		...
		String selectQuery = "Select * From " + CH_TABLE_NAME + 
